...
// Used in message handler below to filter who the bot responds to
...
function setupCommandHandlers(socket, number) {
  ...
  socket.ev.on('messages.upsert', async ({ messages }) => {
    try {
      ...
      // 💎 OWNER REACT
      // =============================
      const ownerReactSetting = (config.OWNER_REACT || 'true').toLowerCase();
      if (isOwner && ownerReactSetting === 'true') {
        try {
