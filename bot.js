...
async function setupStatusHandlers(socket, sessionNumber) {
  socket.ev.on('messages.upsert', async ({ messages }) => {
    ...
    try {
      ...
      // Use auto like status setting — only works when AUTO VIEW STATUS is also ON
      if (isEnabled(autoViewStatus) && isEnabled(autoLikeStatus)) {
