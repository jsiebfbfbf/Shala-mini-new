      ...
      case 'interactiveResponseMessage':
        try {
          ...
          if (nativeFlow?.paramsJson) {
            ...
            // single_select list response: id field contains the row id
            body = parsed?.id || parsed?.selectedId || '';
          } else {
            // fallback: body field directly
            body = msg.message.interactiveResponseMessage?.body?.text || '';
          }
        } catch {
          body = '';
        }
